"""
Django settings for upload_system project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-oa3_jsv5_9-h^@igqr+96=vgmus41#l&!w&h-#%)rd&w%*8@vp')
...
WSGI_APPLICATION = 'upload_system.wsgi.application'
